    ...
    $('#jsResetPwdBtn').click(function(){
        $.ajax({
            ...
            success: function(data) {
                ...
                }else if(res_msg.password1){
                    Dml.fun.showValidateError($("#pwd"), res_msg.password1);
                }else if(res_msg.password2){
                    Dml.fun.showValidateError($("#repwd"), res_msg.password2);
                }else if(res_msg.msg){
                    Dml.fun.showValidateError($("#pwd"), res_msg.msg);
                    Dml.fun.showValidateError($("#repwd"), res_msg.msg);
                }
            }
        });
    });
