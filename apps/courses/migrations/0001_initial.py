# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-08-14 13:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('low', '初级'), ('middle', '中级'), ('high', '高级')], max_length=6, verbose_name='课程难度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(upload_to='course/resource/%Y/%m', verbose_name='附件')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
